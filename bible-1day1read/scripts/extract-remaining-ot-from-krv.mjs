#!/usr/bin/env node
/**
 * Extract remaining OT books from KRV (Korean Revised Version).
 * Output: translations-remaining-ot.json for merging into generate-all-translations.
...
const OUT_PATH = path.join(__dirname, 'translations-remaining-ot.json');
